...
export default function ContactPage() {
  ...
  useEffect(() => {
    document.title = lang === 'zh' ? '联系我们 - VAPOR-X 电子烟批发' : 'Contact Us - VAPOR-X Vape Wholesale'
  ...
  return (
    <div className="bg-white min-h-screen">
      {/* SEO Meta */}
      <Head>
        <meta name="description" content={lang === 'zh'
          ? '联系 VAPOR-X 美国电子烟批发供应商 — 获取批发报价、产品目录、配送信息。24小时内回复。'
          : 'Contact VAPOR-X USA vape wholesale supplier — Get wholesale pricing, product catalog, shipping info. Reply within 24 hours.'} />
      </Head>
